...
<div class="wrapper">
	<header class="main-header">
		...
		<?php $this->load->view('BackEnd/GlobalTemplate/GlobalHeader/HeaderNavbarServicio.php'); ?>
	</header>
	<!-- Left side column. contains the logo and sidebar -->
	<aside class="main-sidebar">
		<?php $this->load->view('BackEnd/GlobalTemplate/GlobalAside/LeftSidebarServicio.php'); ?>
	</aside>

  <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
   <?php $this->load->view('BackEnd/GlobalTemplate/GlobalNavigation/MenuServicio.php'); ?>
